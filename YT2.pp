...
def generate():
    ...
    # Construct prompt with the YouTube link and English output instruction
    prompt = (
        ...
        "IMPORTANT: If the video contains speech in a language other than English, please translate and write the entire transcript in fluent English."
    )
    ...
    # Run generation and save output to Vid/Transcript
    output_path = os.path.join("Vid", "Transcript")
