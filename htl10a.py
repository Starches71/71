...
# Directories                           input_dir = "best_io"
output_dir = "best_io2"                 htl10_script = "htl10aa.py"  # Updated to htl10aa.py
...
def remove_silences(input_file, output_file):
    # FFmpeg command to remove silence      command = [
        "ffmpeg", "-i", input_file,             "-af", "silenceremove=1:0:-30dB",  # Adjust the threshold here
